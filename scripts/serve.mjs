...
const publicFiles = new Map([['/', ['index.html', 'text/html']], ['/index.html', ['index.html', 'text/html']], ...['boot', 'app', 'core', 'api', 'artblocks', 'rankings', 'config', 'storage'].map(n => [`/${n}.js`, [`${n}.js`, 'text/javascript']]), ...['styles', 'accessibility'].map(n => [`/${n}.css`, [`${n}.css`, 'text/css']])]);
